                            ...
                            <div class="col-md-10 col-12">
                                    <div class="col-12">
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" id="first-name" value="${user.user.userName}" style="text-align: center" disabled>
                                            <label for="first-name" style="text-align: center">userName </label>
                                        </fieldset>
                                    </div>
                                    <div class="col-12" >
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" id="last-name" value="${user.user.fullName}" style="text-align: center" disabled>
                                    ...
                                    <div class="col-12 text-center">
                                         ...
                                         <div class="btn-group text-right"><a class="btn-gradient-secondary btn-sm white" onclick="showFormChangePassword()">Edit Password</a></div>
                                    </div>                     
                            </div> 
                        </div>
                    </div>
                            ...
                            <div class="col-md-10 col-12">          
                                    <div class="col-12" >
                                        <fieldset class="form-label-group">
                                            ...
                                            <label for="last-name" style="text-align: center">Password</label>
                                        </fieldset>
                                    </div>       
                                    <div class="col-12" >
                                        <fieldset class="form-label-group">
                                            <input type="text" class="form-control" id="passwordNew" name="passwordNew" style="text-align: center">
                                            <label for="last-name" style="text-align: center">New Password</label>
                                        </fieldset>
                                    </div>              
                                     <div class="col-12 text-center">
                                          <div class="btn-group"><a class="btn-gradient-secondary btn-sm white" onclick="changePassword()">Edit</a></div>
                                          <div class="btn-group"><a class="btn-gradient-secondary btn-sm white" onclick="showFormProfile()">ProFile</a></div>
                                    </div>  
                            </div>
                        </div>
